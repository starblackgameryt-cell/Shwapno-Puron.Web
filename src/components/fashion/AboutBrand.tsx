...
export function AboutBrand() {
  ...
  return (
    <section id="about" className="py-12 sm:py-20 lg:py-32 bg-brand-ivory">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-20 items-center">
          <ScrollReveal direction="left">
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 lg:-bottom-8 lg:-right-8 btn-lux p-3 sm:p-5 lg:p-8">
          ...
          <ScrollReveal direction="right">
            <div className="lg:pl-8">
              <span className="text-[10px] sm:text-[11px] tracking-[0.2em] sm:tracking-[0.3em] uppercase text-brand-gold font-medium font-serif-lux">{get('about_label')}</span>
              <h2 className="mt-2 sm:mt-3 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-black text-brand-emerald tracking-tight font-display zari-underline">
              ...
              <div className="mt-6 sm:mt-8 grid grid-cols-3 gap-0 divide-x divide-stone-200">
                <div className="pr-2 sm:pr-4">
                  <p className="text-lg sm:text-2xl lg:text-3xl font-black text-brand-emerald">{get('about_stat1_number')}</p>
                ...
                <div className="px-2 sm:px-4">
                  <p className="text-lg sm:text-2xl lg:text-3xl font-black text-brand-emerald">{get('about_stat2_number')}</p>
                ...
                <div className="pl-2 sm:pl-4">
                  <p className="text-lg sm:text-2xl lg:text-3xl font-black text-brand-emerald">{get('about_stat3_number')}</p>
