...
// GET - Admin: get all payment methods (including inactive)
export async function GET(request: Request) {
  try {
    ...
    return Response.json({ error: 'পেমেন্ট পদ্ধতি লোড করতে সমস্যা' }, { status: 500 })
  }
}

// POST - Admin: create payment method
export async function POST(request: Request) {
  try {
    ...
    // Get max sortOrder
    const maxSort = await db.paymentMethod.findFirst({
    ...
    return Response.json({ error: 'পেমেন্ট পদ্ধতি তৈরি করতে সমস্যা' }, { status: 500 })
  }
}

// PUT - Admin: update payment method
export async function PUT(request: Request) {
  try {
    ...
    return Response.json({ error: 'পেমেন্ট পদ্ধতি আপডেট করতে সমস্যা' }, { status: 500 })
  }
}

// DELETE - Admin: delete payment method
export async function DELETE(request: Request) {
  try {
    ...
    return Response.json({ error: 'পেমেন্ট পদ্ধতি মুছতে সমস্যা' }, { status: 500 })
  }
}
